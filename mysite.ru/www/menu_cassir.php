       ...
       <div class="container">
			<div class="col-md-9 bartop">
	    		...
	    		<form class="navbar-form field">
            	   <input type="text" placeholder="Film" class="form-control search" name="search_film_button">
...
<div align="center" class="container">
	...
	<form action="index.php" method="post">
		...
		<div class="col-md-4">
			<?php
				if($_SESSION['PName'] == 'cassir' or $_SESSION['PName'] == 'admin')
				{
					echo "<button class='send' name='sell'>ПРОДАТЬ БИЛЕТ</button><br><br>";
				}
			?>
			...
			<?php
				...
				{
					echo "<button class='send' name='report'>ОТЧЕТ</button><br><br>";
				}
			?>
